...
const services = [
    ...
    },
    {
        ...
        description: "Custom software and mobile app solutions for business transformation.",
        icon: Smartphone,
    ...
    },
    {
        ...
        description: "Secure data digitization and document management services to streamline your operations.",
        icon: Database,
